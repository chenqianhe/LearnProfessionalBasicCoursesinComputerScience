...
struct qt_meta_stringdata_CPU_t {
    QByteArrayData data[3];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CPU_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CPU_t qt_meta_stringdata_CPU = {
    {
QT_MOC_LITERAL(0, 0, 3), // "CPU"
...
QT_INIT_METAOBJECT const QMetaObject CPU::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_CPU.data,
    qt_meta_data_CPU,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *CPU::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CPU.stringdata0))
