...
HD_PWD='G:/Cqh_files/2021verilog/upload/lab4/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log datapath_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source datapath_top.tcl -notrace
