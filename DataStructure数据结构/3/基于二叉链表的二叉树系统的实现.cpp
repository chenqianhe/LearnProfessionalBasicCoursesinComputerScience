...
int main(){
	...
	while(op){
		...
		switch(op){
			...
			case 5:{
				printf("二叉树管理系统目前共有%d个二叉树\n",Lists.length);
				for(int i=0;i<Lists.length;i++){
					printf("第%d个二叉树，名称为%s\n",i+1,Lists.elem[i].name);
				}
				getchar();getchar();
				break;
			}
